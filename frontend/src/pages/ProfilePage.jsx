        ...
        <div className="booked-slots">
          <div className="ev-slots">
            ...
            {evSlots.length ? <div className="slots-data">
              <ul>{evSlots.slice().reverse().map(slot =>
                <li
                  key={slot._id}
                  className={
                ...
                >
                  ...
                  <span>{slot.pumpId.name}</span>
                  <span>{slot.bookedAt.slice(11, 19)}</span>
                  <span>{slot.bookedAt.slice(0, 10)}</span>
                </li>
              )}</ul>
            </div> : <div className="black">No Slot Booked Yet...</div>}
          </div>
